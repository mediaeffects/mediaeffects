...
```{r plot-heatmap, echo=TRUE, fig.asp=1.75, fig.width=7, fig.cap='Heatmap showing standardized mean values of top moderators across treatment-effect quintiles.', fig.pos='!htbp'}
